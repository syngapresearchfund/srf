	...
	<?php if ( have_posts() ) : ?>
		<div class="<?php echo esc_attr( $container_classes ); ?> text-center">
			...
			<div class="prose lg:prose-xl mx-auto mb-16">
				<p>Our State Advocates are committed to helping families in their state navigate local services and resources. They assist with connecting families to state services, assisting w/developing Individualized Education Programs (IEPs), and accessing other necessary supports. State Advocates ensure that families receive the assistance they need to improve the quality of life for individuals with <span class="italic">SYNGAP1</span>-Related Disorders.</p>
			</div>
