	...
	<?php if ( have_posts() ) : ?>
		<div class="<?php echo esc_attr( $container_classes ); ?> text-center">
			...
			<div class="prose lg:prose-xl mx-auto mb-16">
				<p>Our International Ambassadors are dedicated volunteers who connect with families in their countries, offering crucial information about the SynGAP Research Fund (SRF). They provide details about SRF registries, ongoing studies, and essential contacts. International Ambassadors play a vital role in fostering a supportive global community and ensuring families have access to the latest resources and information.</p>
			</div>
