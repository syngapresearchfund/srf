		...
		<div class="lg:flex justify-between gap-x-14 space-y-12 lg:space-y-0">
				...
				<div id="mc_embed_shell">
					<div id="mc_embed_signup">
						<div class="flex flex-col flex-1 justify-center">
							...
							<form action="https://syngapresearchfund.us4.list-manage.com/subscribe/post?u=5b5957867c282184c537770df&amp;id=001d463f12&amp;f_id=007fc5e9f0" method="post" id="mc-embedded-subscribe-form" name="mc-embedded-subscribe-form" class="flex validate" target="_blank">
								<div id="mc_embed_signup_scroll" class="w-full">
									<input type="email" name="EMAIL" placeholder="email@example.com" id="mce-EMAIL" class="required email w-full p-3 rounded-l outline-none border-2 border-r-0 border-srf-purple-700 focus:border-srf-purple-800 placeholder-srf-purple-400 text-purple-900" required="" value="">
									<div aria-hidden="true" style="position: absolute; left: -5000px;">
										<input type="text" name="b_5b5957867c282184c537770df_001d463f12" tabindex="-1" value="">
									</div>
								</div>
								<button name="subscribe" id="mc-embedded-subscribe" class="p-3 bg-srf-purple-700 hover:bg-srf-purple-800 text-white rounded-r">Submit</button>
							</form>
						...
						<script type="text/javascript">
							(function($) {window.fnames = new Array(); window.ftypes = new Array();fnames[0]='EMAIL';ftypes[0]='email';fnames[1]='MMERGE1';ftypes[1]='text';fnames[2]='MMERGE2';ftypes[2]='text';fnames[3]='MMERGE3';ftypes[3]='address';fnames[4]='MMERGE4';ftypes[4]='address';fnames[5]='MMERGE5';ftypes[5]='text';fnames[6]='MMERGE6';ftypes[6]='text';fnames[7]='MMERGE7';ftypes[7]='text';fnames[8]='MMERGE8';ftypes[8]='text';fnames[9]='MMERGE9';ftypes[9]='text';}(jQuery));var $mcj = jQuery.noConflict(true);
						</script>
					</div>
				</div>
			</div>
			<div class="flex-1 text-center lg:text-right">
				...
				<ul class="flex flex-wrap space-x-3 justify-center xl:justify-end place-items-center">
					...
					<li class="w-24 lg:w-14"><a href="https://globalgenes.org/" target="_blank" rel="noopener noreferrer"><img
					...
					<li class="w-24 lg:w-14"><a href="<?php echo esc_url( 'https://cfcgiving.opm.gov/welcome' ); ?>"><img
