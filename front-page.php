		...
		<div class="container mx-auto px-10 text-center">
			...
			<div class="max-w-5xl mx-auto mb-10 text-gray-400 text-left">
				...
				while ( $events_query->have_posts() ) :
					...
					* called content-___.php (where ___ is the Post Type name) and that will be used instead.
					*/
					get_template_part( 'template-parts/content', 'front-events' );
			...
			<!-- big button / cta -->
			<a href="<?php echo esc_url( site_url( '/news/' ) ); ?>" class="inline-block bg-gray-600 hover:bg-gray-700 rounded py-3 px-8 text-gray-100 transition duration-500 font-bold">View all News articles →</a>
		</div>
	</section>
